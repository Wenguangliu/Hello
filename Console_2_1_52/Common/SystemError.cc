...
const SystemErrorEntry_t systemErrorTable[] =
{
	...
	{ SERR_BC_ILLEGAL_DATE				/* 4056 */,	SERR_ACTION_ABORT,		SERR_ACTION_ABORT,		SERR_ACTION_ABORT,		ESTR_ROTOR_DATE_ILLEGAL,		EISTR_ILLEGAL_BARCODE },
...
//	{ SERR_BC_BAD_CRC					/* 4113 */,	SERR_ACTION_ABORT,		SERR_ACTION_ABORT,		SERR_ACTION_NONE,		ESTR_BARCODE_FORMAT,			EISTR_BARCODE_FORMAT },
	...
	{ SERR_ROC_NOT_THERE				/* 4115 */,	SERR_ACTION_ABORT,		SERR_ACTION_ABORT,		SERR_ACTION_ABORT,		ESTR_UPDATED_ROTOR_TYPE,		EISTR_SOFTWARE_UPDATE },
	...
	{ SERR_BC_QUIET_ZONE				/* 4200 */,	SERR_ACTION_NONE,		SERR_ACTION_NONE,		SERR_ACTION_NONE,		ESTR_BARCODE_FORMAT,			EISTR_BARCODE },
	{ SERR_BC_SET_THRESHOLD				/* 4201 */,	SERR_ACTION_NONE,		SERR_ACTION_NONE,		SERR_ACTION_NONE,		ESTR_BARCODE_SENSOR,			EISTR_BARCODE },
	{ SERR_BC_SET_CURRENT				/* 4202 */,	SERR_ACTION_NONE,		SERR_ACTION_NONE,		SERR_ACTION_NONE,		ESTR_BARCODE_SENSOR,			EISTR_BARCODE },
	{ SERR_BC_READ_TIMEOUT				/* 4203 */,	SERR_ACTION_NONE,		SERR_ACTION_NONE,		SERR_ACTION_NONE,		ESTR_BARCODE_TIMEOUT,			EISTR_BARCODE },
	{ SERR_BC_CALIBRATION_TIMEOUT		/* 4204 */,	SERR_ACTION_NONE,		SERR_ACTION_NONE,		SERR_ACTION_NONE,		ESTR_BARCODE_TIMEOUT,			EISTR_BARCODE },
