...
String( UnitId_t unitId )
{
	switch ( unitId )
	{
		case UID_UL:	return "U/L";
		case UID_GDL:	return "g/dL";
		case UID_GL:	return "g/L";
		case UID_MEQL:	return "mEq/L";
		case UID_MGDL:	return "mg/dL";
		case UID_UGDL:	return "ug/dL";
		case UID_MGL:	return "mg/L";
		case UID_UGL:	return "ug/L";
		case UID_UGML:	return "ug/mL";
		case UID_UKATL:	return "ukat/L";
		case UID_MMOLL:	return "mmol/L";
		case UID_UMOLL:	return "umol/L";
		case UID_NKATL:	return "nkat/L";
		case UID_NMOLL:	return "nmol/L";
		case UID_MLMIN:	return "mL/min";
		case UID_PCT:	return "%";
		case UID_FRAC:	return "";
		case UID_NONE:	return "";
	}
