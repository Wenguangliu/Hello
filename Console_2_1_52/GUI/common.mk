...
EXTRA_INCVPATH+=$(PROJECT_ROOT_Common)
#===== LIBS - a space-separated list of library items to be included in the link.
LIBS+=phexlib
#===== EXTRA_LIBVPATH - a space-separated list of directories to search for library files.
EXTRA_LIBVPATH+=$(PROJECT_ROOT_Common)/$(CPU)/$(patsubst o%,a%,$(notdir $(CURDIR)))
include $(MKFILES_ROOT)/qmacros.mk
#===== EXTRA_OBJS - object files and libraries contributed additionaly on link/archive step
EXTRA_OBJS+=$(PROJECT_ROOT_Common)/x86/a-g/libCommon_g.a
#QNX internal start
