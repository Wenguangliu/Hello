#ifndef __MSGCONSTANTS_H_INCLUDED
#define __MSGCONSTANTS_H_INCLUDED

// These are the AnalysisStatus values in the "A" messages from the Engine. 
...
#endif // __MSGCONSTANTS_H_INCLUDED
