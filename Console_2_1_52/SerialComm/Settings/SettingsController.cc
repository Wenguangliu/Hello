...
//	states[ STATE_CDUPDATE_LOAD_CONTROLS_CD ]			= new StateCdUpdateLoadControlsCd();
...
//	states[ STATE_CDUPDATE_UPDATE_CONTROLS ]			= new StateCdUpdateUpdateControls();
...
//	states[ STATE_REFRANGES_SET_AGE_RANGE ]				= new StateRefRangesSetAgeRange();
...
//	states[ STATE_SECURITY_ADMIN_SEARCH ]				= new StateSecurityAdminSearch();
...
//	states[ STATE_SECURITY_ADMIN_ENTER_DATE ]			= new StateSecurityAdminEnterDate();
	states[ STATE_SECURITY_ADMIN_LIST_ID ]				= new StateSecurityAdminListId();
//	states[ STATE_SECURITY_ADMIN_LIST_EXPIRATION ]		= new StateSecurityAdminListExpiration();
...
//	states[ STATE_SECURITY_ADMIN_SET_DATE ]				= new StateSecurityAdminSetDate();
