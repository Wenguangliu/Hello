...
Enter()
{
	...
	strcpy( data->buttonText[0], strings[ MSTR_ALL_ANALYTES ] );
	strcpy( data->buttonText[1], strings[ MSTR_ANALYTE_GROUPS ] );
	strcpy( data->buttonText[2], strings[ MSTR_SINGLE_ANALYTE ] );
...
Enter()
{
	...
	memset( data, 0, sizeof( GuiMiddleButtonsData_t ) );
	strcpy( data->buttonText[0], strings[ MSTR_ELECTROLYTES ] );
	strcpy( data->buttonText[1], strings[ MSTR_ENZYMES ] );
	strcpy( data->buttonText[2], strings[ MSTR_LIPIDS ] );
	strcpy( data->buttonText[3], strings[ MSTR_MINERALS ] );
	strcpy( data->buttonText[4], strings[ MSTR_PROTEINS ] );
...
Enter()
{
	...
	strcpy( data->buttonText[0], strings[ MSTR_NON_SI ] );
	strcpy( data->buttonText[1], strings[ MSTR_SI ] );
...
Enter()
{
	...
	memset( data, 0, sizeof( GuiMiddleButtonsInfoData_t ) );
	strcpy( data->buttonText[0], "mmol/L" );
	strcpy( data->buttonText[1], "mEq/L" );
...
Enter()
{
	...
	memset( data, 0, sizeof( GuiMiddleButtonsInfoData_t ) );
	strcpy( data->buttonText[0], "U/L" );
	strcpy( data->buttonText[1], "ukat/L" );
...
Enter()
{
	...
	memset( data, 0, sizeof( GuiMiddleButtonsInfoData_t ) );
	strcpy( data->buttonText[0], "mg/dL" );
	strcpy( data->buttonText[1], "mmol/L" );
...
Enter()
{
	...
	strcpy( data->buttonText[0], "mg/dL" );
	strcpy( data->buttonText[1], "mmol/L" );
	strcpy( data->buttonText[2], "mEq/L" );
...
Enter()
{
	...
	memset( data, 0, sizeof( GuiMiddleButtonsInfoData_t ) );
	strcpy( data->buttonText[0], "g/dL" );
	strcpy( data->buttonText[1], "g/L" );
...
Enter()
{
	...
	{
		strcpy( data->items[i][0], analytes[ analyteList.list[ j ] ] );
	}
...
Enter()
{
	...
	sprintf( buff, "%s %s", analytes[ selectedAnalyte ], strings[ TSTR_UNITS ] );
	SetTopLabel( buff );
	...
	buttonIndex = 0;
	strcpy( data->buttonText[ buttonIndex++ ], units.ListString( unitOptions->units[0].unitId ) );
	...
	{
		strcpy( data->buttonText[ buttonIndex++ ], units.ListString( unitOptions->units[1].unitId ) );
	}

	// Add the alternate options.
	for ( i = 2; i < unitOptions->count; i++ )
	{
		strcpy( data->buttonText[ buttonIndex++ ], units.ListString( unitOptions->units[ i ].unitId ) );
	}
