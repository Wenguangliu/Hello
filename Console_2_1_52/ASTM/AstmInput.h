...
typedef enum
{
	AIE_NO_ERROR							= 0x00000000,
	AIE_SERIAL_NUMBER_MISMATCH				= 0x00000001, // s/n input does not match instrument's s/n
	AIE_PATIENT_CONTROL_ID_MISSING			= 0x00000002, // required field empty
	AIE_PATIENT_CONTROL_ID_BAD_FORMAT		= 0x00000004, // invalid character(s) found in field
	AIE_SAMPLE_ID_BAD_FORMAT				= 0x00000008, // invalid character(s) found in field
	AIE_ALTERNATE_ID_BAD_FORMAT				= 0x00000010, // invalid character(s) found in field
	AIE_BIRTHDATE_MISSING					= 0x00000020, // required field empty
	AIE_BIRTHDATE_BAD_FORMAT				= 0x00000040, // incorrect date format
	AIE_GENDER_MISSING						= 0x00000080, // required field empty
	AIE_GENDER_BAD_FORMAT					= 0x00000400, // invalid value
	AIE_RACE_MISSING						= 0x00000800, // required field empty
	AIE_RACE_BAD_FORMAT						= 0x00001000, // invalid value
	AIE_PATIENT_PHONE_NUMBER_BAD_FORMAT		= 0x00002000, // invalid character(s) found in field
	AIE_OWNER_ADMISSION_ID_BAD_FORMAT		= 0x00004000, // invalid character(s) found in field
	AIE_OWNER_ADMISSION_ID_TOO_LONG			= 0x00008000, // too many characters in field
	AIE_AGE_BAD_FORMAT						= 0x00010000, // incorrect age format
	AIE_DATE_OF_VACCINATION_BAD_FORMAT		= 0x00020000, // incorrect date format
	AIE_SAMPLE_TYPE_MISSING					= 0x00040000, // required field empty
	AIE_SAMPLE_TYPE_INVALID					= 0x00080000, // value given is invalid
	AIE_LOCATION_BAD_FORMAT					= 0x00100000, // invalid character(s) found in field
	AIE_ROTOR_NUMBER_MISSING				= 0x00200000, // required field empty
	AIE_ROTOR_NUMBER_INVALID				= 0x00400000, // value given is not valid
	AIE_ACTION_CODE_MISSING					= 0x00800000, // required field empty
	AIE_ACTION_CODE_INVALID					= 0x01000000, // invalid value
	AIE_PHYSICIAN_ID_BAD_FORMAT				= 0x02000000, // invalid character(s) found in field
	AIE_REPORT_TYPE_INVALID					= 0x04000000, // invalid value
	AIE_RECORD_IDENTIFIER_MISSING			= 0x08000000, // required field empty
	AIE_RECORD_IDENTIFIER_INVALID			= 0x10000000, // invalid value
	AIE_ORDER_DATE_TIME_MISSING				= 0x20000000, // required field empty
	AIE_MESSAGE_CONTROL_ID_MISSING			= 0x40000000, // required field empty
	AIE_MESSAGE_CONTROL_ID_INVALID			= 0x80000000, // invalid value
	AIE_ACCESS_PASSWORD_INVALID				= 0x000100000000ULL,	// required field empty or otherwise invalid
	AIE_ACCESS_PASSWORD_INCORRECT			= 0x000200000000ULL,	// calculated value does not match value received
	AIE_ORDER_LABEL_BAD_FORMAT				= 0x000400000000ULL,	// invalid character(s) found in field
	AIE_MESSAGE_DATE_TIME_INVALID			= 0x000800000000ULL,	// invalid format for date/time
	AIE_MESSAGE_DATE_TIME_INCORRECT			= 0x001000000000ULL,	// message date/time differs from analyzer date/time
} AstmInputErrorCode_t;
