...
typedef enum
{
    ...
    STATE_COOL_AMBIENT_TEMP_SETTING,
    STATE_COOL_AMBIENT_TEMP_SETTING_CONFIRM,
    ...
    STATE_ENGINE_CODE_DOWNLOAD_ERROR,
	STATE_CDUPDATE_WARNING,
	STATE_COMM_NETWORK_CHECK,
	STATE_COMM_NETWORK_ENTER_ANALYZER_IP,
	STATE_COMM_NETWORK_ENTER_SOCKET,
	STATE_COMM_NETWORK_ENTER_GATEWAY,
	STATE_COMM_NETWORK_ENTER_IP_MASK,
	STATE_COMM_NETWORK_ENTER_SERVER_IP,
	STATE_COMM_NETWORK_ENTER_SERVER_SOCKET,
	STATE_COMM_NETWORK_ENTER_CLIENT_SOCKET,
	STATE_COMM_NETWORK_ENTER_HOST_NAME,
	STATE_COMM_ASTM_LAYER,
    STATE_COMM_HL7_LAYER,
    STATE_COMM_HL7_CONFIG_SELECT,
	STATE_COMM_TCPIP_SELECT,
    STATE_COMM_IP_ADDRESS_MODE_SELECT,
    STATE_COMM_NETWORK_SETTING,
	STATE_COMM_TCPIP_SETTINGS,
//	STATE_COMM_STATIC_TCPIP_SETTINGS,
//  STATE_COMM_DHCP_TCPIP_SETTINGS,
	STATE_COMM_ERROR,
	STATE_COMM_SELECT,
    STATE_COMM_SET_PROTOCOL,
    STATE_COMM_SELECT_PROTOCOL,
