...
void InitStates()
{
	...
	states[ STATE_ENGINE_CODE_DOWNLOAD_ERROR ]		    = new StateEngineDownloadError();
	states[ STATE_CDUPDATE_WARNING ]					= new StateCdUpdateWarning();
	states[ STATE_COMM_NETWORK_CHECK ]					= new StateCommNetworkCheck();
	states[ STATE_COMM_NETWORK_ENTER_ANALYZER_IP ]		= new StateCommNetworkEnterAnalyzerIp();
	states[ STATE_COMM_NETWORK_ENTER_GATEWAY ]			= new StateCommNetworkEnterGateway();
	states[ STATE_COMM_NETWORK_ENTER_IP_MASK ]			= new StateCommNetworkEnterIpMask();
	states[ STATE_COMM_NETWORK_ENTER_SERVER_IP ]		= new StateCommNetworkEnterServerIp();
	states[ STATE_COMM_NETWORK_ENTER_SOCKET ]	        = new StateCommNetworkEnterSocket();
	states[ STATE_COMM_ASTM_LAYER ]						= new StateCommAstmLayer();
	states[ STATE_COMM_HL7_LAYER ]						= new StateCommHl7Layer();
	states[ STATE_COMM_HL7_CONFIG_SELECT ]		        = new StateCommHl7ConfigSelect();
	states[ STATE_COMM_TCPIP_SELECT ]					= new StateCommTcpIpSelect();
	states[ STATE_COMM_IP_ADDRESS_MODE_SELECT ]			= new StateCommIpAddressModeSelect();
	states[ STATE_COMM_NETWORK_SETTING ]		        = new StateCommNetworkSetting();
	states[ STATE_COMM_NETWORK_ENTER_HOST_NAME ]	    = new StateCommEnterHostname();
    
	states[ STATE_COMM_TCPIP_SETTINGS ]			        = new StateCommTcpIpSettings();
	...
	states[ STATE_COOL_AMBIENT_TEMP_SETTING ]			= new StateAdvancedCoolAmbientTempSetting();
	states[ STATE_COOL_AMBIENT_TEMP_SETTING_CONFIRM ]   = new StateAdvancedCoolAmbientTempSettingConfirm();
}
