...
typedef enum
{
    ...
    SERR_P100_RPM                       = 0x4057,       // 100rpm spindle motor error
    ...
    SERR_N5500_RPM                      = 0x407f,       // -5500rpm spindle motor error
    SERR_N1000_RPM                      = 0x4080,       // -1000rpm spindle motor error
    SERR_P1000_RPM                      = 0x4081,       // +1000rpm spindle motor error
...
//	SERR_BC_BAD_CRC						= 0x4113,
    ...
    SERR_DATABASE_FILE_TOO_LARGE        = 0x4135,        // Windows CE default.vol database file size too larger_
...
//	SERR_P5V							= 0x4300,		// +5 v error
    ...
    SERR_SOFTWARE_EXPIRED               = 0x430c,       // system software expired
    SERR_ENGINE_OUT_SYNC                = 0x430d,       // engine code out of sync
    SERR_ENGINE_CODE_DOWNLOAD           = 0x430e,       // engine (fpga) code fail to update
                                                        // 0x4400 - 0x44FF  reserved for AMS test errors
    SERR_ETHERNET_PORT                  = 0x4500,       // console board enthernet port error
    SERR_USB_PORT                       = 0x4501,       // console board USB port error
    SERR_CD_ROM                         = 0x4502,       // console board CD ROM hardware error
    SERR_SOUND_DRIVE                    = 0x4503,       // console board sound driver error
    SERR_TOUCH_SCREEN                   = 0x4504,       // console board touch screen error 
    SERR_LCD                            = 0x4505,       // LCD display error
    SERR_CF                             = 0x4506,       // console Compact Flash card error 
    SERR_CUVETTE_TEST_ERROR             = 0x4406,       // Cuvette test error from engine
