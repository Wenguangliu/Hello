...
#define ENGINE_COMM_QUEUE_NAME	L"/EngineComm"
...
typedef enum
{
    ...
    MSG_ENGINE_COMM_OUT_MESSAGE_DATA,
 ...
 */
 typedef struct
{
	void * filler;		// Adeneo - WinCE C compiler requires that a struct has at least one member
