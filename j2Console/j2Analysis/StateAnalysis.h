...
extern OrderDisplayList_t   orderListBak [5];
...
protected:
    ...
    bool            IsBarcodeError (SystemErrNum_t errNum);
    SystemErrNum_t  ProcessEngineError (SystemErrNum_t errNum);

    static bool                 watchDogDisable;
	...
	static long long			rotor1Counter;			// Used for both rotor 1 and rotor 100 IDs.
